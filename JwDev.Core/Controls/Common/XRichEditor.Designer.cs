namespace JwDev.Core.Controls.Common
{
	partial class XRichEditor
	{
		...
		private void InitializeComponent()
		{
			...
			this.stylesBar = new DevExpress.XtraRichEdit.UI.StylesBar();
			...
			this.commonBar = new DevExpress.XtraRichEdit.UI.CommonBar();
			...
			this.lcItemEditor = new DevExpress.XtraLayout.LayoutControlItem();
			...
			((System.ComponentModel.ISupportInitialize)(this.lcItemEditor)).BeginInit();
			((System.ComponentModel.ISupportInitialize)(this.richEditBarController1)).BeginInit();
			this.SuspendLayout();
			// 
			// lc
			// 
			this.lc.Controls.Add(this.editor);
			this.lc.Dock = System.Windows.Forms.DockStyle.Fill;
			this.lc.Location = new System.Drawing.Point(0, 93);
			this.lc.Name = "lc";
			this.lc.OptionsView.UseDefaultDragAndDropRendering = false;
			this.lc.Root = this.lcGroupBase;
			this.lc.Size = new System.Drawing.Size(800, 507);
			this.lc.TabIndex = 0;
			this.lc.Text = "layoutControlEx1";
			// 
			// editor
			// 
			this.editor.ActiveViewType = DevExpress.XtraRichEdit.RichEditViewType.Draft;
			this.editor.Location = new System.Drawing.Point(2, 3);
			this.editor.MenuManager = this.barManager1;
			this.editor.Name = "editor";
			this.editor.Options.Fields.UseCurrentCultureDateTimeFormat = false;
			this.editor.Options.Layout.DraftView.MatchHorizontalTableIndentsToTextEdge = true;
			this.editor.Options.MailMerge.KeepLastParagraph = false;
			this.editor.Size = new System.Drawing.Size(796, 502);
			...
			this.barManager1.MaxItemId = 130;
			...
			// clipboardBar
			// 
			this.clipboardBar.Control = this.editor;
			this.clipboardBar.DockCol = 1;
			this.clipboardBar.DockRow = 0;
			this.clipboardBar.DockStyle = DevExpress.XtraBars.BarDockStyle.Top;
			this.clipboardBar.LinksPersistInfo.AddRange(new DevExpress.XtraBars.LinkPersistInfo[] {
			...
			// fontBar
			// 
			this.fontBar.Control = this.editor;
			...
			// 
			this.capitalizeEachWordCaseItem1.Id = 30;
			...
			// paragraphBar
			// 
			this.paragraphBar.Control = this.editor;
			this.paragraphBar.DockCol = 1;
			this.paragraphBar.DockRow = 2;
			...
			// stylesBar
			// 
			this.stylesBar.Control = this.editor;
			this.stylesBar.DockCol = 2;
			this.stylesBar.DockRow = 0;
			this.stylesBar.DockStyle = DevExpress.XtraBars.BarDockStyle.Top;
			this.stylesBar.LinksPersistInfo.AddRange(new DevExpress.XtraBars.LinkPersistInfo[] {
			...
			// editingBar
			// 
			this.editingBar.Control = this.editor;
			this.editingBar.DockCol = 2;
			this.editingBar.DockRow = 2;
			this.editingBar.DockStyle = DevExpress.XtraBars.BarDockStyle.Top;
			this.editingBar.LinksPersistInfo.AddRange(new DevExpress.XtraBars.LinkPersistInfo[] {
            new DevExpress.XtraBars.LinkPersistInfo(this.findItem1),
            new DevExpress.XtraBars.LinkPersistInfo(this.replaceItem1)});
			this.editingBar.Offset = 680;
			// 
			// findItem1
			// 
			...
			// tablesBar
			// 
			this.tablesBar.Control = this.editor;
			this.tablesBar.DockCol = 0;
			this.tablesBar.DockRow = 2;
			this.tablesBar.DockStyle = DevExpress.XtraBars.BarDockStyle.Top;
			this.tablesBar.LinksPersistInfo.AddRange(new DevExpress.XtraBars.LinkPersistInfo[] {
            new DevExpress.XtraBars.LinkPersistInfo(this.insertTableItem1),
            new DevExpress.XtraBars.LinkPersistInfo(this.insertPictureItem1, true),
            new DevExpress.XtraBars.LinkPersistInfo(this.insertFloatingPictureItem1),
            new DevExpress.XtraBars.LinkPersistInfo(this.insertTextBoxItem1, true),
            new DevExpress.XtraBars.LinkPersistInfo(this.insertSymbolItem1, true),
            new DevExpress.XtraBars.LinkPersistInfo(this.insertHyperlinkItem1, true)});
			// 
			// insertTableItem1
			// 
			...
			// commonBar
			// 
			this.commonBar.Control = this.editor;
			...
			// fileSaveItem1
			// 
			this.fileSaveItem1.Id = 128;
			this.fileSaveItem1.Name = "fileSaveItem1";
			// 
			// fileSaveAsItem1
			// 
			this.fileSaveAsItem1.Id = 129;
			...
			this.barDockControlTop.Size = new System.Drawing.Size(800, 93);
			// 
			...
			this.toggleFirstRowItem1.Id = 71;
			...
			this.toggleBandedRowsItem1.Id = 73;
			...
			this.toggleFirstColumnItem1.Id = 74;
			...
			this.toggleLastColumnItem1.Id = 75;
			...
			//this.toggleBandedColumnItem1.Id = 76;
			...
			this.galleryChangeTableStyleItem1.Id = 77;
			...
			this.changeTableBorderLineStyleItem1.Id = 78;
			...
			this.changeTableBorderLineWeightItem1.Id = 79;
			...
			// 
			this.toggleTableCellsInsideVerticalBorderItem1.Id = 91;
			...
			// 
			this.toggleTableCellsMiddleLeftAlignmentItem1.Id = 118;
			...
			// 
			this.toggleTableCellsBottomLeftAlignmentItem1.Id = 119;
			...
			// 
			this.toggleTableCellsTopCenterAlignmentItem1.Id = 120;
			...
			// 
			this.toggleTableCellsMiddleCenterAlignmentItem1.Id = 121;
			...
			this.lcGroupBase.Padding = new DevExpress.XtraLayout.Utils.Padding(0, 0, 1, 0);
			this.lcGroupBase.Size = new System.Drawing.Size(800, 507);
			this.lcGroupBase.Text = "lcGroupBase";
			this.lcGroupBase.TextVisible = false;
			// 
			// lcItemEditor
			// 
			this.lcItemEditor.Control = this.editor;
			this.lcItemEditor.CustomizationFormText = "lcItemEditor";
			this.lcItemEditor.Location = new System.Drawing.Point(0, 0);
			this.lcItemEditor.Name = "lcItemEditor";
			this.lcItemEditor.Size = new System.Drawing.Size(800, 506);
			this.lcItemEditor.Text = "lcItemEditor";
			this.lcItemEditor.TextSize = new System.Drawing.Size(0, 0);
			this.lcItemEditor.TextToControlDistance = 0;
			this.lcItemEditor.TextVisible = false;
			// 
			...
			((System.ComponentModel.ISupportInitialize)(this.lcItemEditor)).EndInit();
		...
		private DevExpress.XtraLayout.LayoutControlItem lcItemEditor;
		...
		private DevExpress.XtraRichEdit.UI.ClipboardBar clipboardBar;
		...
		private DevExpress.XtraRichEdit.UI.StylesBar stylesBar;
		...
		private DevExpress.XtraRichEdit.UI.EditingBar editingBar;
		...
		private DevExpress.XtraRichEdit.UI.TablesBar tablesBar;
		...
		private DevExpress.XtraRichEdit.UI.CommonBar commonBar;
